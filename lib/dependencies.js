...
const installAdvancedDependencies = (dbChoice) => {
    ...
    const deps = ['express', 'cors', 'dotenv', 'cookie-parser', 'bcryptjs', 'jsonwebtoken', 'zod', 'multer', 'nodemailer', 'node-cache', 'axios', 'winston', 'winston-daily-rotate-file', 'morgan'];
    ...
    const devDeps = [
        ...
        '@types/nodemailer', '@types/node', '@types/morgan',
